...
class EditorSession:
    ...
    def push_history(self):
        ...
        if self.working_atoms.calc:
            state.calc = self.working_atoms.calc
    ...
    def undo(self) -> Optional[Atoms]:
        ...
        if self.working_atoms.calc:
            current.calc = self.working_atoms.calc
    ...
    def preserve_calculator(self, new_atoms: Atoms):
        ...
        if self.working_atoms.calc:
            new_atoms.calc = self.working_atoms.calc
    ...
    def sync_current_frame(self):
        ...
        if self.working_atoms.calc:
            self.trajectory_frames[self.current_frame].calc = self.working_atoms.calc
    ...
    def set_frame(self, frame_index: int) -> Atoms:
        ...
        if self.trajectory_frames[frame_index].calc:
            self.working_atoms.calc = self.trajectory_frames[frame_index].calc
        return self.working_atoms
    ...
    def reset_current_frame(self):
        ...
        if source.calc:
            self.working_atoms.calc = source.calc
