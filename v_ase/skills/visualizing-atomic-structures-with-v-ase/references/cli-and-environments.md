...
The 0.4.7 downloads are Mac DMGs (Apple silicon or Intel, macOS 15+) and a
...
```bash
python -m pip install "v_ase-gui==0.4.7"
```

Optional Rhino export:

```bash
python -m pip install "v_ase-gui[rhino]==0.4.7"
```
...
```bash
python -m pip install --upgrade --force-reinstall "v_ase-gui==0.4.7"
```
