...
**0.3.3 · MCP scene tools** · [Changes](https://v-ase.readthedocs.io/en/latest/whats-new.html)

An ASE-native viewer and editor for structures, trajectories and volumetric data.
...
| Work with | Guide |
| --- | --- |
| Atoms and molecules | [Select, transform, build](https://v-ase.readthedocs.io/en/latest/editing.html) |
| Periodic interfaces | [Cells, matching, registry](https://v-ase.readthedocs.io/en/latest/periodic-interfaces.html) |
| Trajectories and fields | [Analysis](https://v-ase.readthedocs.io/en/latest/trajectories-analysis.html) · [Volumetric data](https://v-ase.readthedocs.io/en/latest/volumetric-guide.html) |
| Figures and projects | [Appearance](https://v-ase.readthedocs.io/en/latest/visualization.html) · [Export](https://v-ase.readthedocs.io/en/latest/projects-export.html) |
...
[Project HTML](https://v-ase.readthedocs.io/en/latest/projects-export.html#project-html) · [Export HTML View](https://v-ase.readthedocs.io/en/latest/projects-export.html#html-view)
...
[Atomic distributions](https://v-ase.readthedocs.io/en/latest/atomic-distributions.html) · [ASE crystal builder](https://v-ase.readthedocs.io/en/latest/editing.html#build-a-periodic-bulk-crystal-with-ase)
...
[Insertion workflow](https://v-ase.readthedocs.io/en/latest/editing.html#batch-insertion-workspace)
...
[Pivot controls](https://v-ase.readthedocs.io/en/latest/editing.html#rotation-and-scaling-pivots)
...
[Same-lattice matching](https://v-ase.readthedocs.io/en/latest/periodic-interfaces.html#commensurate-same-lattice-rotation)
...
[Host/guest workflow](https://v-ase.readthedocs.io/en/latest/periodic-interfaces.html#separate-host-and-guest-lattices)
...
[Registry maps](https://v-ase.readthedocs.io/en/latest/periodic-interfaces.html#registry-maps) · [Rigid relaxation](https://v-ase.readthedocs.io/en/latest/periodic-interfaces.html#rigid-registry-relaxation)
...
[Measurements](https://v-ase.readthedocs.io/en/latest/trajectories-analysis.html#ordered-geometry-through-a-trajectory)
...
[Trajectory analysis](https://v-ase.readthedocs.io/en/latest/trajectories-analysis.html#displacement-analysis)
...
[Colorscales](https://v-ase.readthedocs.io/en/latest/trajectories-analysis.html#map-numeric-per-atom-data) · [Forces](https://v-ase.readthedocs.io/en/latest/trajectories-analysis.html#stored-force-vectors)
...
[Isosurfaces](https://v-ase.readthedocs.io/en/latest/volumetric-guide.html#create-an-isosurface) · [Planes](https://v-ase.readthedocs.io/en/latest/volumetric-guide.html#add-planar-sections) ·
[Combine fields](https://v-ase.readthedocs.io/en/latest/volumetric-guide.html#combine-compatible-datasets)
...
[Constraint guide](https://v-ase.readthedocs.io/en/latest/constraints-relaxation.html#supported-constraint-state)

### FixedLine

Restrict motion to a line. [Details](https://v-ase.readthedocs.io/en/latest/constraints-relaxation.html#fixedline)
...
[FixedPlane](https://v-ase.readthedocs.io/en/latest/constraints-relaxation.html#fixedplane) · [FixScaled](https://v-ase.readthedocs.io/en/latest/constraints-relaxation.html#fixscaled-and-fixcartesian)
...
Apply spring-like restraints. [Details](https://v-ase.readthedocs.io/en/latest/constraints-relaxation.html#hookean)
...
[Repulsion](https://v-ase.readthedocs.io/en/latest/constraints-relaxation.html#built-in-repulsion-calculator) · [Run relaxation](https://v-ase.readthedocs.io/en/latest/constraints-relaxation.html#run-an-ordinary-relaxation)
...
[Appearance](https://v-ase.readthedocs.io/en/latest/visualization.html#per-atom-overrides)
...
[Materials and rendering](https://v-ase.readthedocs.io/en/latest/visualization.html#d-and-flat-2d-rendering)
...
[Bond controls](https://v-ase.readthedocs.io/en/latest/visualization.html#bonds)
...
[Images and video](https://v-ase.readthedocs.io/en/latest/projects-export.html#image-output) ·
[Render Area](https://v-ase.readthedocs.io/en/latest/projects-export.html#render-area) ·
[Blender / OBJ / Rhino](https://v-ase.readthedocs.io/en/latest/projects-export.html#d-scene-output) ·
[Projects and presets](https://v-ase.readthedocs.io/en/latest/projects-export.html#save-project)
