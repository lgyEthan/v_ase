...
```bash
curl -fL https://raw.githubusercontent.com/lgyEthan/v_ase/v0.3.7/v_ase/chatgpt_bootstrap.py -o chatgpt_bootstrap.py
```

```bash
curl -fL https://raw.githubusercontent.com/lgyEthan/v_ase/v0.3.7/v_ase/chatgpt.py -o chatgpt.py
```
