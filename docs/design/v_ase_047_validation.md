...
from the local diagnostic log. The quiet Intel signed-bundle run remains a
release gate; native Intel CI success alone does not replace it. The signed
application was not modified for this diagnostic. A final installation-guide
