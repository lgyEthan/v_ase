...
:::{important}
This page describes the v_ase 0.2.35a1+symmetry contract. At runtime, the installed live
...
Install the isolated symmetry build:
...
limits. In v_ase 0.2.35a1+symmetry the live contract advertises **62 operations** and
